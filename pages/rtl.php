  ...
  <aside
    ...
    <div class="sidenav-footer mx-3 ">
      ...
      <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/argon-dashboard" target="_blank"
        class="btn btn-dark btn-sm w-100 mb-3">Documentation
      </a>
    </div>
  </aside>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Cristiano Ronaldo</h6>
                            <p class="text-xs text-secondary mb-0">cr7@siuuu.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0">DIRECCION</p>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Florian Thauvin</h6>
                            <p class="text-xs text-secondary mb-0">Florian@france.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Rogelio Funes Mori</h6>
                            <p class="text-xs text-secondary mb-0">funesmori@rayados.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Andre Pierre Gignac</h6>
                            <p class="text-xs text-secondary mb-0">serdeluz.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Lionel Messi</h6>
                            <p class="text-xs text-secondary mb-0">lio_messi@psg.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Vincent Janssen</h6>
                            <p class="text-xs text-secondary mb-0">Vincent@Janssen.com</p>
                          </div>
                        </div>
                      </td>
                      <td>
