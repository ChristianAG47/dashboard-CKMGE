      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Registro Ventas</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Registro Ventas</h6>
        </nav>
        ...
        <div class="col-md-14 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">Registro de ventas</h6>
            </div>
            <div class="card-body pt-4 p-3">
              <form>
                <div class="form-group"> <!-- Street 1 -->
                    <label for="street1_id" class="control-label">Producto</label>
                    <input type="text" class="form-control" id="street1_id" name="street1" placeholder="Producto">
                </div>                    
                                        
                <div class="form-group"> <!-- Street 2 -->
                    <label for="street2_id" class="control-label">Precio</label>
                    <input type="number" class="form-control" id="street2_id" name="street2" placeholder="Precio">
                </div>    
