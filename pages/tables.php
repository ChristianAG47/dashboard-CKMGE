              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success">Terminado</span>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0">EQUIPO</p>
                        <p class="text-xs text-secondary mb-0">MODELO</p>
                      </td>
                      <td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center">
                        <input class="text-secondary text-xs font-weight-bold" type="date" id="start" name="trip-start" value="2022-10-19" 
                        min="2022-11-25" max="2024-01-31">
                      </td>
                      <td class="align-middle">
                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Send
